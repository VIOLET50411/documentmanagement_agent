    ...
    <div class="card section-card">
      <div class="evaluation-header">
        ...
        <div class="action-group">
          <button class="refresh-btn" @click="runEvaluation" :disabled="dashboard.evaluationRunning">
            {{ dashboard.evaluationRunning ? "运行中..." : "重新评估" }}
          </button>
          <button class="btn btn-ghost" @click="downloadRuntimeMetrics('csv')">导出 CSV</button>
          <button class="btn btn-ghost" @click="downloadRuntimeMetrics('json')">导出 JSON</button>
        </div>
      </div>
